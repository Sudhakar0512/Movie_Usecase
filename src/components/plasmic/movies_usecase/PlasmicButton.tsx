...
import sty from "./PlasmicButton.module.css"; // plasmic-import: ESyl9Ym6WnsL/css

import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: RX2ZAl3U3jT3/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__hSmn2)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__bFYm)}
                role={"img"}
              />
            ),
