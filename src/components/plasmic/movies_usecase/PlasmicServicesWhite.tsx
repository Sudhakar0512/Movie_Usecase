...
import sty from "./PlasmicServicesWhite.module.css"; // plasmic-import: H0sHJETK__-X/css

import Icon8Icon from "./icons/PlasmicIcon__Icon8"; // plasmic-import: kCA4K1w0sGsT/icon
...
function PlasmicServicesWhite__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___9LohO)}>
        {renderPlasmicSlot({
          defaultContents: (
            <Icon8Icon
              className={classNames(projectcss.all, sty.svg__tidx0)}
              role={"img"}
            />
          ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__aKsi5)}
      >
        <h3
